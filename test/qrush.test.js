describe("QRush Factory Function", function () {
	...
	let dummyChests = [
		{ 'chest_id': 1000, 'prize_ids': [2000], 'location': [-33.9220352, 18.4220006] },
		{ 'chest_id': 1001, 'prize_ids': [], 'location': [-33.923069, 18.4238172] },
		{ 'chest_id': 1002, 'prize_ids': [2001, 2003], 'location': [-33.9117977, 18.4226978] },
		{ 'chest_id': 1003, 'prize_ids': [], 'location': [-33.9327695, 18.4230611] },
		{ 'chest_id': 1004, 'prize_ids': [], 'location': [-33.9278084, 18.4165421] },
		{ 'chest_id': 1005, 'prize_ids': [2002], 'location': [-33.9319319, 18.408851] },
	];
	...
	let dummyPrizes = [
		...
		{ 'prize_id': 2002, 'sponsor_id': 3002, 'prize_title': "10GB Telkom Data Bundle", 'count': 318, 'url': "./img/prizes/telkom_10gb_discount.jpeg" },
		{ 'prize_id': 2003, 'sponsor_id': 3004, 'prize_title': "R200 Uber Voucher", 'count': 169, 'url': "./img/prizes/uber_r200_voucher.jpg" },
	];

	let dummySponsors = [
		{ 'sponsor_id': 3000, 'sponsor_name': "Pick n Pay Family Strand Street", 'location': [-33.920699, 18.421795], 'contact': "Daniel Gray", 'email': "info@picknpay.com" },
		{ 'sponsor_id': 3001, 'sponsor_name': "Ster-Kinekor V&A Waterfront", 'location': [-33.9044466, 18.4193801], 'contact': "Steffany Gretzinger", 'email': "steffanygretzinger@cinema.com" },
		{ 'sponsor_id': 3002, 'sponsor_name': "Telkom Direct Sea Point", 'location': [-33.9113301, 18.3937723], 'contact': "Tamlyn Malcolm", 'email': "tamlyn@telkom.com" },
		{ 'sponsor_id': 3003, 'sponsor_name': "Uber", 'location': [0, 0], 'contact': "Ruby Rider", 'email': "uber@uber.com" },
	];
	...
	describe("functionName", function () {
		it("description of test", function () {
			assert.equal(qRush.functionName(), true);
		});
	});
